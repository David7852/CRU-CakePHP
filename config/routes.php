...
//miembros
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/ver/*', ['action' => 'view']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/editar/*', ['action' => 'edit']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/nuevo/*', ['action' => 'add']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/listar/*', ['action' => 'index']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/ingresar/*', ['action' => 'login']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/salir', ['action' => 'logout']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/registrate', ['action' => 'add']);});
Router::scope('/miembros',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/reiniciar/*', ['action' => 'reset']);});
//trabajadores
...
//login
Router::scope('/',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/salir', ['action' => 'logout']);});
Router::scope('/',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/ingresar/*', ['action' => 'login']);});
Router::scope('/',['controller' => 'Miembros'],function (RouteBuilder $routes) {    $routes->connect('/registrate/*', ['action' => 'add']);});
//general
Router::scope('/', function (RouteBuilder $routes) {    $routes->connect('/inventario', ['controller' => 'Pages', 'action' => 'display', 'inventario']);});
Router::scope('/', function (RouteBuilder $routes) {    $routes->connect('/solicitudes', ['controller' => 'Pages', 'action' => 'display', 'solicitudes']);});
Router::scope('/', function (RouteBuilder $routes) {    $routes->connect('/miembros', ['controller' => 'Pages', 'action' => 'display', 'miembros']);});
Router::scope('/', function (RouteBuilder $routes) {    $routes->connect('/telefonia', ['controller' => 'Pages', 'action' => 'display', 'telefonia']);});
